...
<p>Below are listed PHP Snippets that you have installed on your site.  Select one to add its shortcode to your post or page.  If you would like to add your own PHP Snippets to this list, simply create a PHP file in the directory and save it using a <code>.snippet.php</code> extension.</p>
...
<div id="php_snippets_footer">
	<p style="margin:10px;">
		...
		<!-- span class="php-snippets-link">
			<a href="http://wordpress.org/tags/custom-content-type-manager?forum_id=10" target="_blank"><img class="cctm-img" src="<?php print PHP_SNIPPETS_URL; ?>/images/forum.png" height="32" width="32" alt="forum"/></a>
			<a href="http://wordpress.org/tags/custom-content-type-manager?forum_id=10" target="_blank"><?php _e('Forum', 'php_snippets'); ?></a>
		</span -->
	</p>
